...
HD_PWD='C:/Users/Suwira/Hardware Synthesis Lab I/Final Project/Final Project.runs/clk_viz_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_viz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_viz.tcl
