module top_module(
    ...
    assign ov7670_reset = !btnC;

    assign led0 = config_finished;
    ...
    // address_gen addr_ctrl (
    //     .x( (video_on) ? x : 10'd0 ), // Force x to 0 when off-screen
    //     .y( (video_on) ? y : 10'd0 ), // Force y to 0 when off-screen
    //     .addr(vga_addr)
    // );
    ...
    always @(*) begin
        case(sw)
            ...
            3'b010: processed_pixel = {gray[7:4], gray[7:4], gray[7:4]};        // Grayscale
