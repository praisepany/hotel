...
#
# Script generated by Vivado on Thu May 07 22:46:20 +0700 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : top_controller.sh
...
#
# Usage        : top_controller.sh
#                top_controller.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                top_controller.sh [-rerun]
#                top_controller.sh [-reset_run]
#                top_controller.sh [-clean]
#                top_controller.sh [-reset_log]
#                top_controller.sh [-help]
#
...
# script info
echo -e "top_controller.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./top_controller.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L blk_mem_gen_v8_4_12 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot top_controller xil_defaultlib.top_controller xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim top_controller -key {Behavioral:sim_1:Functional:top_controller} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb top_controller.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./top_controller.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: top_controller.sh [-help]\n\
Usage: top_controller.sh [-step]\n\
Usage: top_controller.sh [-lib_map_path]\n\
Usage: top_controller.sh [-rerun]\n\
Usage: top_controller.sh [-reset_run]\n\
Usage: top_controller.sh [-clean]\n\
Usage: top_controller.sh [-reset_log]\n\
Usage: top_controller.sh [-keep_index]\n\
Usage: top_controller.sh [-noclean_files]\n\n\
